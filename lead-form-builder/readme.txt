...
* Fix: Edit form routing improved by checking formid only.
* Fix: Nonce redirect issue fixed to prevent broken GET parameters.
* Fix: Field label/default value spacing preserved.
* Update: Form Title placeholder improved with naming example.

= 2.2.2 =
* Fix: New form duplication issue fixed after save.
* Fix: Edit form refresh re-submission issue fixed.
* Fix: Added proper redirect after save/update to prevent duplicate submissions.
...
* New: Added duplicate form creation feature.
* New: Added email notifications, spam protection (CAPTCHA), and redesigned form settings page for a better user experience.
* Update: Added back button on all pages for easier navigation.
* Update: Redesigned dashboard with a more modern and user-friendly interface. 
...
* Update: Improved default AJAX handling.
* Fix: Replaced deprecated success function with done() in AJAX for better compatibility and modern standards.
...
= 1.9.6 =
* Fix: Blocks undefined issue fixed.
