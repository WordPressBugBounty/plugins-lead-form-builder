                ...
                <div class="wrap">
                    <form method="post" action="' . esc_url( $update_url ) . '" id="new_lead_form">
                        <div class="lfb-form-title-wrap">
                            ...
                            <input type="text" class="new_form_heading" name="post_title" placeholder="' . esc_attr__( 'Enter form title', 'lead-form-builder' ) . '" value="' . esc_attr( $form_title ) . '" id="title" autocomplete="off">
                        </div>';
        $this->lfb_basic_form();
